...
const ECHO_TEXTURES: Dictionary = {
	...
	&"SIREN": preload("res://art/city/enemies/archetypes/23-choir-siren.png"),
	&"LONGBOW": preload("res://art/city/enemies/archetypes/16-longbow-railgun-tank.png"),
	&"BASILISK": preload("res://art/city/enemies/archetypes/08-basilisk-mortar-platform.png"),
	&"SHRIKE": preload("res://art/city/enemies/archetypes/13-shrike-assault-vtol.png"),
	&"SERAPH": preload("res://art/city/enemies/archetypes/25-seraph-carrier.png"),
	&"GOLIATH": preload("res://art/city/enemies/archetypes/18-goliath-siege-walker.png"),
	&"NEMESIS": preload("res://art/city/enemies/archetypes/19-nemesis-titan-hunter-mech.png"),
}
