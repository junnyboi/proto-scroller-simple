...
const PROJECTILE_ATLAS: Texture2D = preload(
	"res://assets/city/enemies/choir-attacks/district-projectile-vfx.webp"
)
const IMPACT_ATLAS: Texture2D = preload(
	"res://assets/city/enemies/choir-attacks/district-impact-vfx.webp"
)
const ATTACK_ATLAS: Texture2D = preload(
	"res://assets/city/enemies/choir-attacks/district-attack-vfx.webp"
)
const ENEMY_BULLET_IMPACT_ATLAS: Texture2D = preload(
	"res://assets/enemies/impacts/enemy_bullet_impact.png"
)
const ENEMY_SHELL_IMPACT_ATLAS: Texture2D = preload(
	"res://assets/enemies/impacts/enemy_shell_impact.png"
)
const ENEMY_ROCKET_DIRECT_IMPACT_ATLAS: Texture2D = preload(
	"res://assets/enemies/impacts/enemy_rocket_direct_impact.png"
)
const ENEMY_ROCKET_SALVO_IMPACT_ATLAS: Texture2D = preload(
	"res://assets/enemies/impacts/enemy_rocket_salvo_impact.png"
)
