...
const TELEGRAPH_BADGE: Texture2D = preload(
	"res://assets/presentation/telegraph_badge.png"
)
const TARGET_MARK_SUPPORT: Texture2D = preload(
	"res://assets/presentation/target_mark_support.png"
)
const JAMMER_PULSE: Texture2D = preload(
	"res://assets/city/effects/support/jammer-pulse.png"
)
const SHIELD_PULSE: Texture2D = preload(
	"res://assets/city/effects/support/shield-pulse.png"
)
