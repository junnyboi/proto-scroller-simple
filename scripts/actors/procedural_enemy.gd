...
const REPAIR_SUPPORT_PULSE: Texture2D = preload(
	"res://assets/city/enemies/effects/repair-support-pulse.png"
)
const NEMESIS_MELEE_LANCE: Texture2D = null
const CHOIR_CONTACT_BRACE: Texture2D = null
const CHOIR_CONTACT_LEAP: Texture2D = null
const CHOIR_CONTACT_DROP: Texture2D = null
const CHOIR_CONTACT_FOOTPRINT: Texture2D = null
const CONVENTIONAL_DEPLOYMENT: Texture2D = null
const CHOIR_INCUBATION_PAYLOAD: Texture2D = null
