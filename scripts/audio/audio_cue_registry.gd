...
const OVERDRIVE_ACTIVATION_SFX: AudioStream = preload(
	"res://assets/audio/sfx/rampage/overdrive_activation.wav"
)
const COMBO_BREAK_SFX: AudioStream = preload(
	"res://assets/audio/sfx/rampage/combo_break.wav"
)
const UPGRADE_CONFIRM_SFX: AudioStream = preload(
	"res://assets/audio/sfx/upgrades/upgrade_confirm.wav"
)
const SHOP_PURCHASE_SFX: AudioStream = preload(
	"res://assets/audio/sfx/shop/shop_purchase.wav"
)
const SHOP_REPAIR_SFX: AudioStream = preload(
	"res://assets/audio/sfx/shop/shop_repair.wav"
)
const POWER_BOX_DETONATION_SFX: AudioStream = preload(
	"res://assets/audio/sfx/city/power_box_detonation.wav"
)
const ENEMY_BULLET_IMPACT_SFX: AudioStream = preload(
	"res://assets/audio/sfx/enemy_projectiles/enemy_bullet_impact.wav"
)
const ENEMY_SHELL_IMPACT_SFX: AudioStream = preload(
	"res://assets/audio/sfx/enemy_projectiles/enemy_shell_impact.wav"
)
const ENEMY_ROCKET_DIRECT_IMPACT_SFX: AudioStream = preload(
	"res://assets/audio/sfx/enemy_projectiles/enemy_rocket_direct_impact.wav"
)
const ENEMY_ROCKET_SALVO_IMPACT_SFX: AudioStream = preload(
	"res://assets/audio/sfx/enemy_projectiles/enemy_rocket_salvo_impact.wav"
)
