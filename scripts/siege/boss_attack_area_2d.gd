...
const LANE_PLATE_TEXTURE: Texture2D = preload(
	"res://assets/bosses/boss-lane-footprint.png"
)
const LINE_BEAM_TEXTURE: Texture2D = preload("res://assets/bosses/boss-line-beam.png")
...
const CORE_CHARGE_SFX: AudioStream = preload(
	"res://assets/audio/sfx/boss/s04_core_charge.ogg"
)
const SHOCKWAVE_RELEASE_SFX: AudioStream = preload(
	"res://assets/audio/sfx/boss/s04_shockwave_release.ogg"
)
