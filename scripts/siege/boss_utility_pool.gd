...
const MIMESIS_AFTERIMAGE_TEXTURE: Texture2D = null
const ARCHIVE_TREASURY_TEXTURE: Texture2D = preload(
	"res://assets/bosses/utilities/boss-archive-treasury-bracket.png"
)
const EVACUATION_CRADLE_TEXTURE: Texture2D = null
const EXTRACTION_CLAMP_TEXTURE: Texture2D = null
const SHOW_CONTROL_CABINET_TEXTURE: Texture2D = null
const RUBBLE_BED_TEXTURE: Texture2D = preload(
	"res://assets/bosses/utilities/boss-rubble-bed.png"
)
const FREIGHT_RECLAMATION_ANCHOR_TEXTURE: Texture2D = null
const SERAPH_PROJECTION_TEXTURE: Texture2D = null
const CHOIR_PYLON_TEXTURE: Texture2D = preload("res://assets/finale/choir-pylon.png")
