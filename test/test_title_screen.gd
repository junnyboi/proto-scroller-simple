...
func test_launch_scene_contract() -> void:
	...
	assert_eq(ProjectSettings.get_setting("application/config/name"), "Proto Scroller — Act 1")
	assert_eq(
...
func test_settings_menu_applies_and_persists_the_complete_audio_mix() -> void:
	...
	var sliders: Dictionary = {
		...
		AudioVolumeSettings.Channel.UI: screen.get_node("%UiVolumeSlider"),
	}
	var labels: Dictionary = {
		...
		AudioVolumeSettings.Channel.UI: screen.get_node("%UiVolumeValue"),
	}
	var mute_buttons: Dictionary = {
		...
		AudioVolumeSettings.Channel.UI: screen.get_node("%UiMuteButton"),
	}
	var requested: Dictionary = {
		...
		AudioVolumeSettings.Channel.UI: 52.0,
	}
	...
	for channel: int in AudioVolumeSettings.CHANNELS:
		var slider_name: String = {
			...
			AudioVolumeSettings.Channel.UI: "%UiVolumeSlider",
		}[channel]
		assert_almost_eq(
		...
		var mute_button_name: String = {
			...
			AudioVolumeSettings.Channel.UI: "%UiMuteButton",
		}[channel]
...
func test_reference_global_tab_fixture_and_back_navigation() -> void:
	# Reference-only presentation fixture; production navigation remains local.
	screen.leaderboard_overlay.global_navigation_enabled = true
...
func test_title_leaderboard_saves_validated_callsign_and_refreshes_identity() -> void:
	...
	assert_true(overlay.row_labels[0].text.contains("TITLE ACE"), "Historical runs preserve the callsign recorded at completion.")
...
func test_generated_title_art_and_minimal_briefing_contract() -> void:
	...
	var host_source: String = FileAccess.get_file_as_string("res://web/loader.js")
	...
	assert_true(shell_source.contains("GODOT_CONFIG"))
	assert_true(shell_source.contains("canvasResizePolicy: 0"))
	var css: String = FileAccess.get_file_as_string("res://web/loader.css")
	assert_true(css.contains("width: 100dvw"))
	assert_true(css.contains("height: 100dvh"))
	assert_true(css.contains("max-width: none"))
