...
func test_catalog_has_sixty_nine_unique_sorted_enabled_descriptors() -> void:
	...
	assert_eq(unique.size(), 69)
	assert_eq(catalog.categories().size(), 6)
